...
import { DomainTaskType, removeTaskTC, updateTaskTC } from "features/TodolistsList/tasksSlice";
...
export const Task = memo(({ task, todoId }: TaskPropsType) => {
  ...
  return (
    <ListItem disableGutters disablePadding sx={getListItemSx(task.status)}>
      <div>
        <Checkbox
